\chapter[Tipping Points and the Climate-Carbon System]{Tipping Points and the \\ Climate-Carbon System}
\graphicspath{{introduction1/figs}}
\label{sec:intro1}

\section{Tipping Points}
\lettrine[lines=3,loversize=0.1,findent=0.1em,nindent=0em]{T}{ake} a pan of water and heat it up.
As its temperature rises, some of the water's properties may change. For example, its thermal conductivity increases.
...
\end{equation}
where $F(\ \rho | T)$ gives the state of $F$ with control parameter $\rho$ at time $T$. The inclusion of an observation time allows for the fact that changes
in the system may not be apparent until after the critical value has been exceeded.
...
which absorb infrared radiation, principally \ce{CO2} and \ce{H2O}, the radiation that escapes to space is emitted from higher in the atmosphere that it would be in their absence.
An effective emission height can be defined which
radiates with the effective emission temperature and then because the atmospheric temperature increases towards the Earth's surface in the troposphere
this makes the surface warmer than it would otherwise be.
...
decreases the amount of outgoing radiation. As less radiation is now emitted to space the Earth's climate responds. It does this by increasing the Earth's surface temperature
...
\end{equation}
known as \emph{Equilibrium Climate Sensitivity} which is measured in units of temperature \parencite{Charney1979}.
...
The value of $\mathrm{ECS}$ is uncertain. State of the art climate models (CMIP$6$) do not agree on its value, and give a range of
\SIrange{1.8}{5.6}{\kelvin} \parencite{Zelinka2020}, which represents an increase in uncertainty from CMIP$5$, although some researchers have suggested that ECS could be even
...
in temperature. In CMIP$6$ \parencite{Arora2020} the carbon-concentration feedback is $\SI{0.97\pm0.40}{\peta\gram\carbon\per\ppm}$ for the land and $\SI{0.79\pm 0.07}{\peta\gram\carbon\per\ppm}$
for the ocean.
...
about the nature of the change the Earth system is experiencing. It could be a smooth function of increasing \ce{CO2} or tipping dynamics could be possible \parencite{Broecker1987}.
...
in emitted carbon dioxide \parencite{Allen2009,Rogelj2019} and not expected to continue after emissions cease \parencite{MacDougall2020}, which is related to
decreasing atmospheric \ce{CO2} levels offsetting the thermal inertia of the climate system. However certain cloud resolving models
...
There is observational evidence of decreasing AMOC stability \parencite{Boers2021a,Michel2022,Ditlevsen2023}. Some CMIP$5$ models show AMOC tipping at low
...
of anthropogenic carbon \parencite{Brienen2015}. The forest affects climate by changing the albedo and aerodynamic roughness of the surface,
...
some CMIP$5$ models \parencite{Drijfhout2015} showed signs of Amazon dieback and CMIP$6$ models show examples of regional Amazon dieback \parencite{Parry2022}.
...
Whilst many of the findings about tipping points are uncertain,
...
\Cref{eq:energy_balance_sb} can be solved, revealing two possible stable states as shown in \cref{fig:energy_balance_solution}.
\begin{figure}
  \centering
...
\begin{figure}
  ...
  \caption[NGRIP record of Dansgaard Oeschger events]{A record of \ce{\delta^{18}O} from the NGRIP ice core from Greenland \parencite{NGRIP2004} over the last 100,000
	years.
