\chapter[Mathematical Theory of Tipping Points and Early Warning Signals]{Mathematical Theory of Tipping \\ Points and Early Warning Signals}
\chaptermark{Theory of Tipping Points and Early Warning Signals}
\label{sec:intro2}
...
\end{equation}
This can then be integrated from $x_{min}$ to $x_3$ to give
\begin{equation}
