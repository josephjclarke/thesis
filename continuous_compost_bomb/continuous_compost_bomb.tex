...
This was then converted back to dimensional units and plotted in \cref{fig:equilibrium_soil_temperature_profile}.

\begin{figure}
  \centering
  \includegraphics[keepaspectratio,width=\textwidth]{equilibrium_profile}
  \caption[Equilibrium Soil Temperature Profile]{The equilibrium soil temperature profile, using the parameters in \cref{tab:standard_values}. This is given as an anomaly relative to $T_{a0}$.}
