...
modeled as existing on a semi-infinite line, which extends from the surface at $z = 0$ down to $z = -\infty$. It is assumed that soil carbon
...
for $|c_2| \rightarrow \infty$ behaves like $F(c_2) \sim 2|c_2|$ so it follows %from Rolle's Theorem\cite{Bourbaki2004}
