...
and thus
\begin{equation}
  \psi = \ln \frac{c_1}{2\mathcal{W}} + \ln \left(1 - \tanh^2 \left(c_2 \pm \sqrt{c_1} x\right)\right).
\end{equation}
Using the Pythagorian identity\cite{riley2006} this can be reduced to
\begin{equation}
  \psi = \ln \frac{c_1}{2\mathcal{W}} + 2\ln \left(\sech \left(c_2 \pm \sqrt{c_1} x\right)\right).
\end{equation}
...
the $c_2$ that satisfies $F'(c_2) = 0$ must be found and substituted back into \cref{eq:nondimensional_model_nonuniform_upper_boundary_condition} to give. The deriviative of $F$
is
\begin{equation}
  F'(c_2) = \frac{\sech^2 \frac{c_2}{2}}{2D} + \tanh\frac{c_2}{2},
\end{equation}
so that when $F'(c_2) = 0$, \cref{eq:nondimensional_model_nonuniform_upper_boundary_condition} becomes
\begin{equation}
  \mp\frac{\sech^2 \frac{c_2}{2}}{2D^2} - 2 \ln \sech \frac{c_2}{2} = -\frac{1}{D} - \ln 2\mathcal{W}D^2 - \delta\theta_a.
\end{equation}
\begin{equation}
