...
modelled as existing on a semi-infinite line, which extends from the surface at $z = 0$ down to $z = -\infty$. It is assumed that the vertical structure of
soil carbon is set, as is sometimes assumed \parencite{Burke2017}, by a balance soil carbon diffusion and respiration. It is assumed that this vertical structure has reached equilibrium,
which has the form of an exponential decrease with depth over a characteristic distance of $H$. The soil temperature is modelled by a reaction-diffusion system, in which heat is generated
