...
There are 2 values of $\mu$ that satisfy the consistency condition - there are two Hopfs? (Sub/supercritical?)\todo{show what happens as $\epsilon \rightarrow 0$ and
  $f \rightarrow 1$.}