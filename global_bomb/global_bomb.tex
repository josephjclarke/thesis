...
represents the saturation value of NPP at high \ce{CO2} levels. As the pre-indsutrial NPP, $\Pi_0$, is better known, $\Pi_{\infty}$  can be determined from $\Pi_0$ using
the formula
\begin{equation}
...
temperature change happens faster than changes in NPP and soil carbon, those terms can be approximated with their equilibrium values, giving
\begin{equation}
