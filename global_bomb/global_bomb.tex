...
\section{What should I call this section?}
\begin{subequations}
...
\ce{CO2} increases, but beyond a certain level of $\mu$ this amount decreases but remains positive. This can be explained in the following. For $\mu = 0$, ignoring \ce{CO2} fertilisation effects,
