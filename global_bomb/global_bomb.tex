...
gives a value of $\kappa = \SI{2.3}{\watt\per\square\meter\per\kelvin}$, which implies a value of $\Pi_c \approx \SI{4000}{\peta\gram\carbon\per\year}$. This value is much larger than typical
...
\section{Rate Dependent and Transient Effects}