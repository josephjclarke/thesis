...
A vertical dimension was introduced into a model of the compost bomb in \cref{chapter:continuous_compost_bomb}.
It was shown that this does not suppress the compost bomb. That analysis was local ---  the modelling was done at a single point on the Earth's surface. It would be interesting to see
