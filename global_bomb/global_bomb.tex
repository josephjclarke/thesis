...
\begin{equation}
  ...
  \mu^* \sim \frac{c_a \left(\pm\sqrt{f_1^2 k^2 \tau ^2+2 f_1 k \tau  \left(1-r_0 \tau  (k \tau +2)\right)+\left(-k r_0 \tau ^2-1\right)^2}-f_1 k \tau +k r_0 \tau ^2+2 k \tau +2 \Pi' \tau +2 r_0 \tau +1\right)}{2 \Pi_0 \tau} \, \epsilon \rightarrow 0.
\end{equation}
