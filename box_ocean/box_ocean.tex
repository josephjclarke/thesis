...
\begin{figure}
  ...
  \caption{Values of $S$ at the bifurcation point as a function of \ce{CO2} fertilsation and the strength of respiration feedback}
...
Unlike the other two models, the one box model does not give any osciallatory behaviour. The two box model gives  oscillations for all values of $S$ above a threshold, whereas IMOGEN shuts the
