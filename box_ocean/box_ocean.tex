...
The effect of this is that less energy is radiated away to space than was before the emission of greenhouse gases. To be in
...
However, these estimates should be combined with other observational estimates \parencite{Cox2018} as well as paleoclimate records \parencite{Hargreaves2012} as done by~\cite{Sherwood2020}.
...
On human-relevant timescales, these fluxes are controlled by terrestrial and ocean processes \parencite{AR6}. The terrestrial part of the carbon cycle is controlled by the
...
on NPP and heterotrophic respiration related to elevated \ce{CO2} levels that are considered here.
...
$\ce{CO2}$ (as opposed to light or nutrients) then increases in \ce{CO2} will increase NPP \parencite{Wenzel2016}. This \emph{\ce{CO2} fertilisation effect} has been detected
...
on global warming as it tends to decrease the amount of \ce{CO2} in the atmosphere by increasing photosynthesis. This feedback is expected to weaken with increased $\ce{CO2}$ as
fewer plants become limited by \ce{CO2}, there is some observational evidence of this occuring \parencite{Wang2020}.
...
is thought that the Jenkinson effect is larger, which leads to a net positive feedback on the climate system \parencite{Cox2000,Friedlingstein2006,Arora2020}.
...
\begin{figure}
  ...
  \caption{Atmospheric carbon calculated with the IMOGEN model given by \cref{eq:imogen_deterministic} for a range of $S$ values,
...
\begin{figure}
  ...
  \caption{A contour plot showing the value of $S$ as a function of $Q_{10}$ (the temperature dependence of respiration) and $C_{1/2}$ (the strength of the \ce{CO2} fertilisation
...
To find the eigenvalues of the Jacobian, the characteristic polynomial $\det(\bm{J} - \gamma \bm{I})$ = 0 must be solved, where $\gamma$ is an eigenvalue.
...
\begin{figure}
  ...
  \caption{Equilibrium levels of soil carbon as a function of $\mu$ for the one box ocean model, \cref{eq:one_box_ocean},
...
Furthermore because $k > r_0$, then $\chi_0$ will be larger than $1$. This means that $\chi_0$ can't be interpretted as a fraction of carbon absorbed anymore.
...
\begin{figure}
  ...
  \caption{The eigenvalues of the jacobian of the two box model \cref{eq:two_box_ocean} plotted in the complex plane as a function of $\mu$.  The colour of the eigenvalue is given
...
\begin{figure}
  ...
  \caption{Equilibrium levels of soil carbon as a function of $\mu$ for the two box ocean model, \cref{eq:two_box_ocean},
...
\begin{figure}
  ...
  \caption{A comparison of the bifurcation diagrams of the IMOGEN, one box and two box models. Ocean parameters have been chosen so that the bifurcation happens at the same value of $S$.
...
\begin{figure}
  ...
  \caption{The fit of \cref{eq:ocean_response} to the ocean carbon uptake estimated by the Global Carbon Budget using one and two box models. The fitted parameters are given in
