...
In c\ref{fig:imogen_trajectories} The atmospheric carbon calculated using IMOGEN is plotted for a variety of $S$ values. It is clear that at $S$ values comprable to the $S$ values
...
\end{figure}
We can investigate this more thoroughly by plotting the critical $S$ values required for a bifurcation against the $Q_{10}$ values. This is done in
\begin{figure}
  \centering
