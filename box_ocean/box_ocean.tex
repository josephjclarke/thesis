...
As was outlined in \cref{sec:introduction}, the climate system responds to increasing levels of greenhouse gases in the atmosphere by increasing in temperature. The radiative forcing
...
\begin{table}
   ...
   \begin{tabular}{llll}
     ...
     \bottomrule
   \end{tabular}
\caption{Estimates of the ratio of $S$ to $\mathrm{ECS}$ for CMIP5 and CMIP6 models, calculated by the methodology described in \cref{chapter:global_bomb}.
