...
Care is needed when using EWS, as
...
that traditional EWS  can change their characteristics or disappear entirely when these assumptions on the forcing are relaxed. This motivates creating EWS that do not assume white noise.
...
In this section, it will be demonstrated how conventional EWS may fail in the presence of autocorrelated  noise. Due to the fact that near a
...
\begin{equation}
  ...
  \dv{y}{t} = f(y,\mu) + \xi(t).
\end{equation}
The classical theory of EWS assumes $\xi$ is a white noise process, however no such restriction is made here. It may have both
...
The \si{2\meter} air temperature  was chosen as our forcing variable, which
...
of detecting substantial proportions of the identified abrupt shifts. Overall, it can be seen that ROSA outperforms the traditional EWS.
...
In this chapter I have shown how EWS can be generalised to deal with more general noise characteristics. By normalising the power spectrum of the forcing, I am able to extract a 
...
Nevertheless, I believe our approach represents an increase in the flexibility and generality of EWS for tipping points in a changing climate.
