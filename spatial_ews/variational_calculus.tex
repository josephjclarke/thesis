...
%Along with a notion of functional differentiation, there is also a notion of functional integration. I will evalutate an integral, \cref{eq:modified_Z}.
%The integral is
 \begin{equation}
 ...
 % The tactic will be to write $B$ and $z$ in a Fourier basis, in which the path integral reduces to a product of integrals.
