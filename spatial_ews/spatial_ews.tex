...
\begin{equation}
  ...
  \pdv{p}{t} = \int \fdv{z(x')} \left( \fdv{\mathcal{H}}{z(x')} p + \frac{1}{2}\sigma^2 \fdv{p}{z(x')}\right) \dd{x'}.
\end{equation}
...
\begin{figure}
  ...
  \caption[Early Warning Signals in the slowly forced limit]{Early warning signals when $\epsilon = 0.01$. The left column shows 
    ...
    (black) and over time (red). The analytical prediction for $\sigma_s^2$ is plotted with a dashed grey line.
