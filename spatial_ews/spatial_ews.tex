...
\begin{equation}
  ...
  \frac{1}{Z'}\fdv{Z'}{B(x_1)}\eval_{B=0} = \int z(x_1) \frac{e^{-\frac{2}{\sigma^2} \mathcal{H}[z]}}{Z}\,\mathcal{D}z = \int z(x_1) p[z] \,\mathcal{D}z = \E(z(x_1)) = 0
\end{equation}
and similarly
\begin{equation}
  \label{eq:log_deriv_second}
  \frac{1}{Z'}\fdv{B(x_1)}\fdv{Z'}{B(x_2)}\eval_{B=0} = \int z(x_1)z(x_2) p[z]\,\mathcal{D}z .
\end{equation}
