...
To investigate the effects of critical slowing down on variance and autocorrelation, the pdf of \cref{eq:linearised_spatial_D} must be calculated. This system has its own
form of the Fokker-Planck equation for the pdf, $p[z,t]$ which is now a functional of $z$,
\begin{equation}
