...
Whilst the spatially uncoupled system is bistable, traveling waves \parencite{VanDeLeemput2015} generated by noise induced transitions between the two 
...
\section{Applying Spatial Early Warning Signals in Practice}
...
Suppose a candidate tipping element has been identified --- which for concreteness I will take to be the Amazon Rainforest. A spatiotemporal
dataset which represents the state variable, such as Vegetation Optical Depth (VOD). A value of $\epsilon$ should also be estimated. It is to be
hoped that it is small enough. \Cref{tab:epsilon_estimate} suggests that the Amazon Rainforest is a marginal case. By calculating a
...
is plausible that the spatial early warning signals investigated in this chapter may give skillful early warnings.
