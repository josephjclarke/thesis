...
last $800,000$ years \parencite{Bereiter2015}. Other methods, for example using istopic data, can be used to reconstruct even older climates \parencite{Tierney2020}.
...
This snowball state was predicted without empircal evidence, however decades after it was postulated evidence arose for its existence \parencite{Kirschvink1992,Hoffman2002}.
...
$x^*_{\pm} = \pm 2 - \mu$. The stability of these equilibria can be found in the manner descibed in \cref{sec:btipping}, which in this case amounts to evaluating
...
pullback attractor and repellor of the system, $x^{\mathrm{PB}}_{\pm} = \pm \sqrt{4 - r} - \mu$. These pullback objects are the appropriate generalisation of attractors and repellors to the
...
Although real tipping points may have multiple characteristics it is still often possible and, more importantly, still useful to catagorise the tipping into one of the above catagories.
