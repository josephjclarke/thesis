...
\begin{equation}
  ...
  \dv{\bm{x}}{t} = \bm{f}(\bm{x}).
\end{equation}
Suppose the system has a fixed point at $\bm{x}^*$ then the linear stability of the system \parencite{Strogatz2015} is characterised by the behaviour of a small perturbation
...
B- or Bifurcation-tipping refers to tipping which is driven in some sense by a bifurcation. A bifurcation concept from the mathematical theory of dynamical systems,
introduced by~\cite{Poincare1885}.
