...
\end{equation}
This is an example of a potential system because it assumes the deterministic dynamics can be written as the gradient of a potential. This can be done for any one dimensional system but is not
...
frequencies are excited with equal amplitude. This is a questionable assumption for the Earth System, where the sprectrum is not white \parencite{Mithcell1976,VonderHeydt2021} and may
change due to climate change \parencite{Huntingford2013}.
\subsubsection{Theory}
\begin{figure}
  \centering
  \includegraphics{potential_to_escape}
  \caption{An example potential.}
