...
However, the water still remains as water and these changes will vary continuously with the water temperature. However, if the water is heated beyond
...
Let the amount of radiation the Earth emits per unit area be $F$. The Earth, with radius $R$, absorbes energy over a disk, and reradiates
...
\end{equation}
Assuming the Earth radiates as a black body with temperature $T$, then $F = \sigma T^4$ where $\sigma$ is the Steffan-Boltzmann constant  so that $T = \SI{255}{\kelvin}$.
...
When greenhouse gases are emitted into the atmosphere they reduce raise the effective emission height to colder regions of the atmosphere which
