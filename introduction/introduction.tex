...
further, without loss of generality, that there is a bifurcation point at $(\bm{x},\mu)  = (\bm{0},0)$. Then using \cref{thm:center_manifold_theorem} a center manifold passing through
...
\begin{equation}
  ...
  \dv{x}{t} = \mu x - x^2,
\end{equation}
which is a transcritical bifurcation. If $\partial_{xx}f=0$, the bifurcation is known as a pitchfork bifurcation with normal form
\begin{equation}
  \label{eq:pitchfork}
  \dv{x}{t} = \mu x -x^3.
\end{equation}
