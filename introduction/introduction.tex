...
A useful example, taken from~\cite{Ashwin2012}, will now be considered. The system is
\begin{subequations}
  ...
  \end{align}
\end{subequations}
These equations can be interpretted as a system with state $x$ and a parameter $\mu$ that changes at some finite rate, $r$.
