...
When examining the time series these reconsructions generate, some abrupt shifts can be seen \parencite{Boers2022,Brovkin2021}. Although some of these abrupt shifts may not be true tipping
points \parencite{}, it seems likely that many of them are \parencite{EWS papers}.


\subsubsection{Snowball Earth}
\subsubsection{Dansgard Osgard Events (spelling)}
\subsubsection{Saharah Greening}
