...
The Amazon Rainforest is a vast store of carbon, containing around \SI{123}{\peta\gram\carbon} \parencite{Mahli2006}, and has for many years been a sink
of anthropogenic carbon \parencite{}. The vegetation exerts an important influence on its local climate. By shading, evapotranspiration and alebdo effects the rainforest
affects its own temperature \parencite{}. Furthermore, the forest recycles its own rainfall, which acts to increase the precipitation it experiences \parencite{}. It is
...
Other anthropogenic factors can cause abrupt shifts in the Amazon. For example fire, which in the Amazon is caused by humans \parencite{}. Berts Paper.  
Deforestation induced tipping. Percolation paper.

Observational evidence. Amazon now a source. Pauls Paper.
